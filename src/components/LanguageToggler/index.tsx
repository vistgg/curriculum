  ...
  return (
    <Menu as="div" className="relative inline-block w-full text-left md:w-auto">
      <Menu.Button as="div" className="w-full">
        <button className="relative flex items-center gap-2 font-medium before:absolute before:-bottom-1 before:h-0.5 before:w-full before:origin-left before:scale-x-0 before:bg-gray-200 before:transition hover:before:scale-100">
          <Image
          ...
          {isMobile
            ? i18n.language === "en-US"
              ...
              : "Português (BR)"
            : null}
          <ChevronDown className="h-3.5 w-3.5 text-white" aria-hidden="true" />
        </button>
      </Menu.Button>
